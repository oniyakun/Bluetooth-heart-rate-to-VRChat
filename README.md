...
1. 前往 [Releases页面](../../releases) 下载最新版本的 `BluetoothHeartRate.exe`
2. 双击运行exe文件即可使用
3. 无需安装Python环境或依赖包

> 💡 **提示**: 如果你只是想使用程序，直接下载exe文件是最简单的方式！
...
> ⚠️ **注意**: 如果你已经从Releases页面下载了exe文件，可以跳过此安装步骤！

**以下步骤仅适用于开发者或需要从源码运行的用户：**
...
如果你从Releases页面下载了exe文件：

1. 双击运行 `BluetoothHeartRate.exe`
2. 程序会自动扫描并显示可用的心率设备
3. 选择你的设备即可开始使用
